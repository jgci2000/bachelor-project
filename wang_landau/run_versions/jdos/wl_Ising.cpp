...
int main(int argc, char **argv)
{
    ...
    double f = exp(1);
    double f_final = 1 + pow(10, - atoi(argv[1]));
    ...
    string save_file = "JDOS_2D_WL_Ising_" + std::to_string(ising.dim) + "D_" + ising.lattice + "_L" + std::to_string(ising.L) + "_f" + std::to_string((int) - log10(f_final - 1)) + "_flatness" + std::to_string((int) (flatness * 100));
