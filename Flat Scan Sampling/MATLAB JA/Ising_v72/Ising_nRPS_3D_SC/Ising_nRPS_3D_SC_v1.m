...
%
wspace_filename = ['workspace_nRPS_Ising_v1_', dim, '_', lattice_type, '_L', int2str(L), '_REP_1E', int2str(log10(REP)), '_skip_', int2str(skip)];
JDOS_filename = ['JDOS_nRPS_Ising_v1_', dim, '_', lattice_type, '_L', int2str(L), '_REP_1E', int2str(log10(REP)), '_skip_', int2str(skip)];
%
disp([datestr(now,'dd/mm/yyyy HH:MM:SS'), ' | start run of ', 'nRPS_Ising_v1_', dim, '_', lattice_type, '_L', int2str(L), '_REP_1E', int2str(log10(REP)), '_skip_', int2str(skip)]);
%
