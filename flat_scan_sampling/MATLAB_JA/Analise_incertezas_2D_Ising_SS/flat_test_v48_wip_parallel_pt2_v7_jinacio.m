...
%
load workspace_ft_v48_parallel_L4R1E4x1E3.mat
%
L = 4;
q_M0 = L^2/2 + 1;
%
...
title('DOS for checkerbord configuration')
%
subplot(1,3,2)
...
title('DOS for slice configuration')
%
subplot(1,3,3)
...
title('DOS for E=0,M=0 configuration')
%
