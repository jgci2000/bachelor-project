...
int main(int argc, char **argv) 
{
    ...
    string console_output = "L: " + std::to_string(L) + " | f_final: " + std::to_string((int) - log10(f_final - 1)) + " | flatness: " + std::to_string((int) (flatness * 100));
    ...
    if (WRITE_FILE == 1) 
    {
        std::ofstream file1("./CPP Data/JDOS_2D_" + std::to_string(L) + "L_f" + std::to_string((int) - log10(f_final - 1)) + "_flatness" + std::to_string((int) (flatness * 100)) + "_WL_CPP.txt");
        for (int i = 0; i < NE; i++) 
        {
            for (int j = 0; j < NM; j++) 
                file1 << JDOS[i * NM + j] << " ";
        ...
        std::ofstream file2("./CPP Data/JDOS_2D_" + std::to_string(L) + "L_f" + std::to_string((int) - log10(f_final - 1)) + "_flatness" + std::to_string((int) (flatness * 100)) + "_WL_CPP_data.txt");
        ...
        std::ofstream file3("./CPP Data/JDOS_2D_" + std::to_string(L) + "L_f" + std::to_string((int) - log10(f_final - 1)) + "_flatness" + std::to_string((int) (flatness * 100)) + "_WL_CPP_console_logs.txt");
